    ...
    <div class="span5 offset1">
      <div class="well">
        <div class="pull-left" style="padding-right: 1em;">
          <a href="http://carboncostume.com" target="_blank"><img src="../img/carboncostume.png"></a>
        </div>
        <div class="clearfix">
          <h3><a href="http://carboncostume.com" target="_blank">Carbon Costume</a></h3>
          <p><a href="http://carboncostume.com" target="_blank">Costume DIY Guides for Cosplay and Halloween made from Everyday Gear</a></p>
        </div>
      </div>
    </div>
  </div>
...
<br><br><br><br>
     ...
     <!-- Footer
      ...
      <footer id="footer">
        ...
        Made by <a href="http://thomaspark.me" rel="nofollow">Thomas Park</a>. Contact him <a href="mailto:thomas@bootswatch.com">thomas@bootswatch.com</a>.<br/>
